...
namespace P3PHelper.Views.SLinks
{
    ...
    public partial class ChariotPage : ContentPage
    {
        public ChariotPage()
        {
            ...
            var sLink = vm.CreateChariotInstance();
        ...
        */
        protected override void OnAppearing()
        {
            ...
            string jsonData = Preferences.Get($"rankUpData_Chariot_{sLink.Arcana}", ""); // Use Arcana property from SLink as unique identifier
        ...
        */
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set($"rankUpData_Chariot_{sLink.Arcana}", jsonData); // Use Arcana property from SLink as unique identifier
        }
        /*
        ...
        */
        private void Checkbox_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
            ...
            Preferences.Set($"rankUpData_Chariot_{sLink.Arcana}", jsonData);
        }
    }
}