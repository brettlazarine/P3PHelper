...
namespace P3PHelper.Views.SLinks
{
    ...
    public partial class DeathPage : ContentPage
    {
        public DeathPage()
        {
            ...
            var sLink = vm.CreateDeathInstance();
        ...
        */
        protected override void OnAppearing()
        {
            ...
            string jsonData = Preferences.Get($"rankUpData_Death_{sLink.Arcana}", ""); // Use Arcana property from SLink as unique identifier
        ...
        */
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set($"rankUpData_Death_{sLink.Arcana}", jsonData); // Use Arcana property from SLink as unique identifier
        }
        /*
        ...
        */
        private void Checkbox_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
            ...
            Preferences.Set($"rankUpData_Death_{sLink.Arcana}", jsonData);
        }
    }
}