...
namespace P3PHelper.Views.SLinks
{
    ...
    public partial class PriestessPage : ContentPage
    {
        public PriestessPage()
        {
            InitializeComponent();
            var vm = new SLinksViewModel();
            var sLink = vm.CreatePriestessInstance();
        ...
        */
        protected override void OnAppearing()
        {
            ...
            string jsonData = Preferences.Get($"rankUpData_Priestess_{sLink.Arcana}", ""); // Use Arcana property from SLink as unique identifier
        ...
        */
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set($"rankUpData_Priestess_{sLink.Arcana}", jsonData); // Use Arcana property from SLink as unique identifier
        }
        /*
        ...
        */
        private void Checkbox_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
            ...
            Preferences.Set($"rankUpData_Priestess_{sLink.Arcana}", jsonData);
        }
    }
}