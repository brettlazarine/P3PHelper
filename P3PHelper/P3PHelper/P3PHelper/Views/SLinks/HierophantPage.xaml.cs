...
namespace P3PHelper.Views.SLinks
{
    ...
    public partial class HierophantPage : ContentPage
    {
        public HierophantPage()
        {
            InitializeComponent();
            var vm = new SLinksViewModel();
            var sLink = vm.CreateHierophantInstance();
        ...
        */
        protected override void OnAppearing()
        {
            ...
            string jsonData = Preferences.Get($"rankUpData_Hierophant_{sLink.Arcana}", ""); // Use Arcana property from SLink as unique identifier
        ...
        */
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set($"rankUpData_Hierophant_{sLink.Arcana}", jsonData); // Use Arcana property from SLink as unique identifier
        }
        /*
        ...
        */
        private void Checkbox_CheckedChanged(object sender, CheckedChangedEventArgs e)
        {
            ...
            Preferences.Set($"rankUpData_Hierophant_{sLink.Arcana}", jsonData);
        }
    }
}